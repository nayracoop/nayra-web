...
<!--            <li><a target="_blank" href="https://open.spotify.com/user/nayracoop" title="Spotify"><font-awesome-icon :icon="['fab', 'spotify']" /><span class="sr-only">Spotify</span></a></li> -->
          ...
          <p>
            ...
            <abbr :title="$t('FACTTIC')"></abbr>
            <a href="http://www.facttic.org.ar/">
              <img class="facttic-logo" :src="require('@/assets/img/facttic.svg')" alt="FACTTIC" width="150" height="42" />
            </a>
            <a href="https://patio.coop/" target="_blank" rel="noopener noreferrer">
              <img class="patio-logo" :src="require('@/assets/img/patio.png')" alt="Patio" width="120" height="60" />
            </a>
          </p>
        </b-col>
      </b-row>
