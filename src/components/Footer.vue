    ...
    <b-container>
      <b-row>
        <b-col cols="12">
          ...
          <img class="data" src="../assets/img/dataweb.jpg" :alt="$t('Data Fiscal')" />
          <p><span>{{ $t('We are part of') }}</span> <abbr :title="$t('FACTTIC')"></abbr><a href="http://www.facttic.org.ar/"><img src="../assets/img/facttic.png" alt="FACTTIC" width="150" height="63" /></a></p>
        </b-col>
      </b-row>
    </b-container>
  </footer>
